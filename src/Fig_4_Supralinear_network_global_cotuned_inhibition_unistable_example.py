...
for l in l_l:
    ...
    if l == 1:
        print(np.mean(l_r_e_1[30000:40000]))
        print(np.mean(l_r_e_2[30000:40000]))
        print(np.mean(l_r_i_1[30000:40000]))
        print(np.mean(l_r_i_2[30000:40000]))
    ...
    if l == 1:
        plt.savefig('paper_figures/png/Fig_4_Supralinear_network_global_inhibition_unistable.png')
        plt.savefig('paper_figures/pdf/Fig_4_Supralinear_network_global_inhibition_unistable.pdf')
    else:
        plt.savefig('paper_figures/png/Fig_4_Supralinear_network_cotuned_inhibition_unistable.png')
        plt.savefig('paper_figures/pdf/Fig_4_Supralinear_network_cotuned_inhibition_unistable.pdf')
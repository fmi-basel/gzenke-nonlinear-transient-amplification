...
for g_e in l_g_e:
    ...
    sio.savemat('data/Fig_5_Pattern_separation_activity_EE_STP_E12_gE_' + str(g_e) + '.mat', mdict={'E12': l_r_e_1_2})
    sio.savemat('data/Fig_5_Pattern_separation_activity_EE_STP_E2_gE_' + str(g_e) + '.mat', mdict={'E2': l_r_e_2})
...
for g_e in l_g_e:
    l_r_e_1_2_EE_STP = sio.loadmat('data/Fig_5_Pattern_separation_activity_EE_STP_E12_gE_' + str(g_e) + '.mat')['E12'][0]
    l_r_e_2_EE_STP = sio.loadmat('data/Fig_5_Pattern_separation_activity_EE_STP_E2_gE_' + str(g_e) + '.mat')['E2'][0]

    l_r_e_1_2_EI_STP = sio.loadmat('data/Fig_5_Pattern_separation_activity_EI_STP_E12_gE_' + str(g_e) + '_U_max_' + str(U_max) + '.mat')['E12'][0]
    l_r_e_2_EI_STP = sio.loadmat('data/Fig_5_Pattern_separation_activity_EI_STP_E2_gE_' + str(g_e) + '_U_max_' + str(U_max) + '.mat')['E2'][0]
...
plt.xlabel('$g_{E}$', fontsize=font_size_1, **hfont)
...
plt.savefig('paper_figures/png/Fig_5_asso_index_peak_ss_changing_gE_U_max_' + str(U_max) + '_EE_STD.png')
plt.savefig('paper_figures/pdf/Fig_5_asso_index_peak_ss_changing_gE_U_max_' + str(U_max) + '_EE_STD.pdf')
...
plt.savefig('paper_figures/png/Fig_5_asso_index_peak_ss_changing_gE_U_max_' + str(U_max) + '_EI_STF.png')
plt.savefig('paper_figures/pdf/Fig_5_asso_index_peak_ss_changing_gE_U_max_' + str(U_max) + '_EI_STF.pdf')
...
plt.ylim([0, 10000])
plt.legend(['E-to-E STD onset transients', 'E-to-E STD fixed point'], prop={"family": "Arial", 'size': font_size_1}, loc='lower right')
plt.savefig('paper_figures/png/Fig_5_sepa_dis_EE_STP_changing_gE_U_max_' + str(U_max) + '.png')
plt.savefig('paper_figures/pdf/Fig_5_sepa_dis_EE_STP_changing_gE_U_max_' + str(U_max) + '.pdf')
...
plt.ylim([0, 10000])
plt.legend(['E-to-I STF onset transients', 'E-to-I STF fixed point'], prop={"family": "Arial", 'size': font_size_1}, loc='lower right')
plt.savefig('paper_figures/png/Fig_5_sepa_dis_EI_STP_changing_gE_U_max_' + str(U_max) + '.png')
plt.savefig('paper_figures/pdf/Fig_5_sepa_dis_EI_STP_changing_gE_U_max_' + str(U_max) + '.pdf')

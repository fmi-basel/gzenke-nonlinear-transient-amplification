...
for p in l_p:
    ...
    plt.savefig('paper_figures/png/Fig_5_Pattern_separation_activity_EE_STP_E12_p_' + str(p) + '_g_e_' + str(g_e) + '_example.png')
    plt.savefig('paper_figures/pdf/Fig_5_Pattern_separation_activity_EE_STP_E12_p_' + str(p) + '_g_e_' + str(g_e) + '_example.pdf')
    ...
    plt.savefig('paper_figures/png/Fig_5_Pattern_separation_activity_EE_STP_E2_p_' + str(p) + '_g_e_' + str(g_e) + '_example.png')
    plt.savefig('paper_figures/pdf/Fig_5_Pattern_separation_activity_EE_STP_E2_p_' + str(p) + '_g_e_' + str(g_e) + '_example.pdf')
...
plt.savefig('paper_figures/png/Fig_3_Supralinear_network_2D_EI_STP.png')
plt.savefig('paper_figures/pdf/Fig_3_Supralinear_network_2D_EI_STP.pdf')
...
plt.savefig('paper_figures/png/Fig_3_Supralinear_network_2D_EI_STP_ISN_index.png')
plt.savefig('paper_figures/pdf/Fig_3_Supralinear_network_2D_EI_STP_ISN_index.pdf')
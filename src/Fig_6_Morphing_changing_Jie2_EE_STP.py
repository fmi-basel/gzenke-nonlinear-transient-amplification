...
for p in l_p:
    ...
    sio.savemat('data/Fig_6_Morphing_activity_EE_STP_E1_Jie2_' + str(J_ie_2) + '_p_' + str(p) + '.mat', mdict={'E1': l_r_e_1})
    sio.savemat('data/Fig_6_Morphing_activity_EE_STP_E2_Jie2_' + str(J_ie_2) + '_p_' + str(p) + '.mat', mdict={'E2': l_r_e_2})
...
plt.savefig('paper_figures/png/Fig_3_Supralinear_network_2D_EE_STP_without_inhibition.png')
plt.savefig('paper_figures/pdf/Fig_3_Supralinear_network_2D_EE_STP_without_inhibition.pdf')
...
plt.savefig('paper_figures/png/Fig_5S_Supralinear_network_2D_EI_STP_capped.png')
plt.savefig('paper_figures/pdf/Fig_5S_Supralinear_network_2D_EI_STP_capped.pdf')
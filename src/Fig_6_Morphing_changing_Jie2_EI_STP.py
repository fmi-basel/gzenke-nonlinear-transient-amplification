...
l_p = [0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.0]
...
for p in l_p:
    ...
    # plt.ylim([0, 10000])
    # plt.legend(['Exc 1', 'Exc 2'], prop={"family": "Arial", 'size': font_size_1}, loc='upper right')
    # plt.savefig('paper_figures/png/Fig_6_Morphing_2D_EI_STP_p_' + str(p) + '.png')

    sio.savemat('data/Fig_6_Morphing_activity_EI_STP_E1_Jie2_' + str(J_ie_2) + '_p_' + str(p) + '.mat', mdict={'E1': l_r_e_1})
    sio.savemat('data/Fig_6_Morphing_activity_EI_STP_E2_Jie2_' + str(J_ie_2) + '_p_' + str(p) + '.mat', mdict={'E2': l_r_e_2})
...
for beta in l_beta:
    ...
    sio.savemat('data/Fig_5_Pattern_separation_activity_EE_STP_E12_beta_' + str(beta) + '.mat', mdict={'E12': l_r_e_1_2})
    sio.savemat('data/Fig_5_Pattern_separation_activity_EE_STP_E2_beta_' + str(beta) + '.mat', mdict={'E2': l_r_e_2})
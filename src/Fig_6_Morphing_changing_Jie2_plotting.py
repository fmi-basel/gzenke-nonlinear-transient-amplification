...
for p in l_p:
    l_r_e_1_EE_STP = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E1_Jie2_0.3_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EE_STP = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E2_Jie2_0.3_p_' + str(p) + '.mat')['E2'][0]
    l_r_e_1_EI_STP = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E1_Jie2_0.3_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EI_STP = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E2_Jie2_0.3_p_' + str(p) + '.mat')['E2'][0]

    l_r_e_1_EE_STP_2 = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E1_Jie2_0.4_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EE_STP_2 = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E2_Jie2_0.4_p_' + str(p) + '.mat')['E2'][0]
    l_r_e_1_EI_STP_2 = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E1_Jie2_0.4_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EI_STP_2 = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E2_Jie2_0.4_p_' + str(p) + '.mat')['E2'][0]

    l_r_e_1_EE_STP_3 = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E1_Jie2_0.5_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EE_STP_3 = sio.loadmat('data/Fig_6_Morphing_activity_EE_STP_E2_Jie2_0.5_p_' + str(p) + '.mat')['E2'][0]
    l_r_e_1_EI_STP_3 = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E1_Jie2_0.5_p_' + str(p) + '.mat')['E1'][0]
    l_r_e_2_EI_STP_3 = sio.loadmat('data/Fig_6_Morphing_activity_EI_STP_E2_Jie2_0.5_p_' + str(p) + '.mat')['E2'][0]
...
plt.yticks([0, 20, 40], fontsize=font_size_1, **hfont)
...
plt.savefig('paper_figures/png/Fig_6_Morphing_EE_STP_changing_Jie2_U_max_' + str(U_max) + '.png')
plt.savefig('paper_figures/pdf/Fig_6_Morphing_EE_STP_changing_Jie2_U_max_' + str(U_max) + '.pdf')
...
plt.xticks([0, 10, 20, 30, 40], [0, 0.25, 0.5, 0.75, 1.0], fontsize=font_size_1, **hfont)
plt.yticks([0, 5, 10], fontsize=font_size_1, **hfont)
plt.xlabel('$p$', fontsize=font_size_1, **hfont)
plt.ylabel('Distance to the decision boundary', fontsize=font_size_1, **hfont)
plt.ylim([0, 10])
plt.legend([r"$J_{IE2}$: 0.3", r"$J_{IE2}$: 0.4", r"$J_{IE2}$: 0.5"], prop={"family": "Arial", 'size': font_size_1}, loc='lower right')
plt.savefig('paper_figures/png/Fig_6_Morphing_EI_STP_changing_Jie2_U_max_' + str(U_max) + '.png')
plt.savefig('paper_figures/pdf/Fig_6_Morphing_EI_STP_changing_Jie2_U_max_' + str(U_max) + '.pdf')
